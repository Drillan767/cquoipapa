                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control{{ $errors->has('last_name') ? ' is-invalid' : '' }}" name="phone" required>
                        ...
                        <div class="form-group row">
                            <label for="is-admin" class="col-md-4 col-form-label text-md-right">Administrateur ?</label>

                            <div class="col-md-6">
                                <input id="is-admin" type="checkbox" class="form-control" name="is-admin" value="1">
                            </div>
                        </div>
